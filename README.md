...
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=cs,css,visualstudio,dotnet,vscode,windows,bitbucket,jira,docker,kubernetes,androidstudio,nodejs,cypress,selenium,mongodb,js,grafana,firebase,apache,postman,prometheus,html,git,jenkins,sqlserver,github,bash,mysql,playwright,kibana&titщles=true)
