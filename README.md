...
<p>
  ...
  ![My Skills](https://go-skill-icons.vercel.app/api/icons?i=cs,dotnet,visualstudio,vscode,windows,css,wordpress,docker,nodejs,selenium,mongodb,js,firebase,grafana,postman,prometheus,html,git,jenkins,github,bash,githubactions,playwright,androidstudio,jira,microsoftcopilot,chatgpt,githubcopilot,sqlserver,mysql&titles=true)
