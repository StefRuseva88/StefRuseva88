...
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=cs,dotnet,visualstudio,vscode,windows,css,wordpress,docker,jira,githubactions,androidstudio,nodejs,mongodb,selenium,playwright,js,firebase,grafana,postman,prometheus,html,git,jenkins,sqlserver,github,bash,k6,chatgpt,mysql&titles=true)
