...
<p>
  ...
  ![My Skills](https://go-skill-icons.vercel.app/api/icons?i=cs,dotnet,visualstudio,vscode,windows,css,wordpress,docker,jira,githubactions,androidstudio,nodejs,selenium,mongodb,playwright,js,firebase,grafana,postman,prometheus,html,git,jenkins,github,bash,chatgpt,githubcopilot,sqlserver,mysql,microsoftcopilot&titles=true)
