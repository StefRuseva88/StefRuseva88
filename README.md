...
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=dotnet,cs,css,visualstudio,vscode,windows,bitbucket,jira,docker,kubernetes,androidstudio,cypress,nodejs,mongodb,selenium.js,grafana,firebase,apache,postman,prometheus,html,git,jenkins,sqlserver,github,bash,kibana.figma,playwright&titщles=true)
