...
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=cs,dotnet,visualstudio,vscode,windows,css,wordpress,docker,jira,githubactions,androidstudio,nodejs,selenium,mongodb,playwright,js,firebase,grafana,postman,prometheus,html,npm,git,jenkins,sqlserver,github,bash,chatgpt,mysql&titles=true)
